						...
						if ((gridX == 0) || (gridY == 0)) {
							if ((gridY > 0) && (gridY < 10)) {
								for (int j = 1; j < 10; j++) {
									...
									bottomColor = myPanel.colorArray[myPanel.mouseDownGridX][myPanel.mouseDownGridY];
									newColor = null;
									do {
							...
							for (int j = 4; j < 7; j++) {
								for (int i = 4; i < 7; i++) {
									...
									do {
										...
										case 0:
											newColor = new Color(0xFF1493);
											break;
										case 1:
											newColor = new Color(0x00BFFF);
											break;
										case 2:
											newColor = new Color(0x006400);
											break;
										}
									} while (bottomColor.equals(newColor));
									myPanel.colorArray[myPanel.mouseDownGridX][myPanel.mouseDownGridY] = newColor;
